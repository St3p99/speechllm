...
class SpeechLLMConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.text_decoder_name_or_path = text_decoder_name_or_path or kwargs.pop(
            "text_decoder_name_or_path", None
        )
        self.speech_encoder_name_or_path = speech_encoder_name_or_path or kwargs.pop(
            "speech_encoder_name_or_path", None
        )
        ...
        self.speech_encoder = AutoConfig.from_pretrained(
            self.speech_encoder_name_or_path
        )
